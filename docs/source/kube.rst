Scaling [tml-multi-agenticai-iot-3f10-ml_agenticai-4f96] With Kubernetes
===========================
...
Based on your TML solution [tml-multi-agenticai-iot-3f10-ml_agenticai-4f96] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`tml-multi-agenticai-iot-3f10-ml_agenticai-4f96.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-tml-multi-agenticai-iot-3f10-ml_agenticai-4f96.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresstml-multi-agenticai-iot-3f10-ml_agenticai-4f96.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f tml-multi-agenticai-iot-3f10-ml_agenticai-4f96.yml -f ollama.yml

tml-multi-agenticai-iot-3f10-ml_agenticai-4f96.yml
------------------------

.. important::
   Copy and Paste this YAML file: tml-multi-agenticai-iot-3f10-ml_agenticai-4f96.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/Vangala09/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/ymls/tml-multi-agenticai-iot-3f10-ml_agenticai-4f96
...
.. code-block:: YAML
   ...
   ################# tml-multi-agenticai-iot-3f10-ml_agenticai-4f96.yml
     ...
     kind: Deployment
     metadata:
       name: tml-multi-agenticai-iot-3f10-ml_agenticai-4f96
     spec:
       selector:
         matchLabels:
           app: tml-multi-agenticai-iot-3f10-ml_agenticai-4f96
       ...
       template:
         ...
         spec:
           containers:
           - name: tml-multi-agenticai-iot-3f10-ml_agenticai-4f96
             image: reshmareddy09/tml-multi-agenticai-iot-3f10-ml_agenticai-4f96-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: SOLUTIONNAME
               value: 'tml-multi-agenticai-iot-3f10-ml_agenticai-4f96'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10'
             - name: GITUSERNAME
               value: 'Vangala09'
             - name: GITREPOURL
               value: 'https://github.com/Vangala09/raspberrypitss'
   ...
   ---
     ...
     kind: Service
     metadata:
       name: tml-multi-agenticai-iot-3f10-ml_agenticai-4f96-visualization-service
       labels:
         app: tml-multi-agenticai-iot-3f10-ml_agenticai-4f96-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/tml-multi-agenticai-iot-3f10-ml_agenticai-4f96 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-tml-multi-agenticai-iot-3f10-ml_agenticai-4f96.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-tml-multi-agenticai-iot-3f10-ml_agenticai-4f96.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-tml-multi-agenticai-iot-3f10-ml_agenticai-4f96.yml
