[tml-multi-agenticai-iot-3f10-ml_agenticai-4f96] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tml-multi-agenticai-iot-3f10-ml_agenticai-4f96] container is NOT running**.

.. tip::
   You must have your [tml-multi-agenticai-iot-3f10-ml_agenticai-4f96] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/Vangala09/raspberrypitss/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/Vangala09/raspberrypitss  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=38883  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Vangala09'  \-\-env DOCKERUSERNAME='reshmareddy09'  \-\-env MQTTUSERNAME=''  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
[tml-multi-agenticai-iot-3f10-ml_agenticai-4f96] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Vangala09/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.2, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=40637, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=34065, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=46565, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=42289, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=36507, HPDEHOST=172.17.0.2, HPDEPORT=34639, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=38077

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2475-tml-multi-agenticai-iot-3f10-ml_agenticai-4f96,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-preprocess-2732-tml-multi-agenticai-iot-3f10-ml_agenticai-4f96,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-ml-997-tml-multi-agenticai-iot-3f10-ml_agenticai-4f96,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-predict-9910-tml-multi-agenticai-iot-3f10-ml_agenticai-4f96,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-agenticai-9195-tml-multi-agenticai-iot-3f10-ml_agenticai-4f96,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
